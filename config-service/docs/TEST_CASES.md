...
- Covered browser behaviors include:
  - service dropdown and parser option visibility
  - plugin add behavior without mode churn
  - config-type mode switch panel visibility
